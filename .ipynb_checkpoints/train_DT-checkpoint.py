...
if __name__ == "__main__":
    model_name = "DT_RBC1_100k_norm_wrapper"
    offline_data_path = "data_interactions/RBCAgent1/model_RBCAgent1_timesteps_100000_rf_CombinedReward_seed_28_norm_wrapper.pkl"
    max_ep_len= 4096
    max_len = 24
    scale = 1
    ...
    model_name = "DT_RBC1_100k_norm_wrapper_cl_{}".format(context_length)
