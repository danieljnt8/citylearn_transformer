...
def train_agent(schema, timesteps, seed, additional= None, saved_path = PATH_MODEL_SB, model_str = "PPO"):
    ...
    data_path = PATH_DATA_INTERACTIONS+ "/" + model_str + "/" + "model_{}_timesteps_{}_seed_{}.pkl".format(model_str,timesteps,seed)
    model_path = PATH_MODEL_SB + "/" + model_str + "/" + "model_{}_timesteps_{}_seed_{}".format(model_str,timesteps,seed)
...
if __name__ == "__main__":
    ...
    train_agent(schema,timesteps = 100000,seed =572)
