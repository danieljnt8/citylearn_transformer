...
def eval(run_path = None, model_path=None,schema = "citylearn_challenge_2022_phase_2",device ="cpu",TARGET_RETURN=-9000,nb_iter = 4095):
    ...
    for t in trange(nb_iter,desc = "Evaluation"):
...
if __name__ == "__main__":
    run_path = "checkpoints/city_learn/DT_RBC1_100k_norm_wrapper_cl_24/run_2/"
    model_path = "checkpoints/city_learn/DT_RBC1_100k_norm_wrapper_cl_24/run_2/checkpoint-25"
    model = TrainableDT.from_pretrained(model_path,local_files_only = True)
    device = "cpu"

    eval(run_path,model_path,device=device,nb_iter = 8760)
